...
config = setup_config(BASE_CONFIG, Path('/home/olivieri/exp/src/train/seg/2-xen-rescale/base/good_ckp-config.yml'))
...
async def main() -> None:
    ...
    if seg_train_with_text_config['with_text']:
        if seg_train_with_text_config['sign_classes_filter_k']:
