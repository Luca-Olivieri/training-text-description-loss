...
from train.seg.loss import VariableTextSigLipLoss
from core.prompter import FastPromptBuilder, make_synthetic_diff_text
from core.logger import LogManager
from core.viz import get_layer_numel_str
from core.torch_utils import compile_torch_model, nanstd, map_tensors, clear_memory, unprefix_state_dict
...
config = setup_config(BASE_CONFIG, Path('/home/olivieri/exp/src/train/seg/3-contrastive-B_vs_dT/3.1-ft_synth_bootstrap/base/phase_2-config.yml'))
            ...
            if seg_train_with_text_config['with_text']:
                ...
                with autocast():
                    ...
                    aux_batch_loss = aux_criterion(
                        ...
                        list_of_text_features=list(cs_global_text_tokens.values()),
...
async def main() -> None:
    ...
    aux_criterion = VariableTextSigLipLoss(negative_loss_agg='sum', ignore_no_positive_samples=True)
